...
namespace google_reviews.Services
{
    public interface IGooglePlacesService
    {
        ...
        Task<CompanyReviewData?> GetReviewsAsync(Company company, bool enableThrottling);
        ...
        Task<string?> SearchPlaceByNameAsync(string businessName, string? address = null);
    }
}